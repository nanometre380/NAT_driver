...
#define FILTER_FRIENDLY_NAME        L"nat_driver_prac9 NDIS LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{bcd8b72c-b937-407e-a59c-56bafe4a071f}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"nat_driver_prac9"
...
DRIVER_DISPATCH natdriverprac9Dispatch;

DRIVER_DISPATCH natdriverprac9DeviceIoControl;
