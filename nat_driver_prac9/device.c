...
#pragma NDIS_INIT_FUNCTION(natdriverprac9RegisterDevice)


_IRQL_requires_max_(PASSIVE_LEVEL)
NDIS_STATUS
natdriverprac9RegisterDevice(
    VOID
    )
{
    ...
    DEBUGP(DL_TRACE, "==>natdriverprac9RegisterDevice\n");
   
    
    NdisZeroMemory(DispatchTable, (IRP_MJ_MAXIMUM_FUNCTION+1) * sizeof(PDRIVER_DISPATCH));
    
    DispatchTable[IRP_MJ_CREATE] = natdriverprac9Dispatch;
    DispatchTable[IRP_MJ_CLEANUP] = natdriverprac9Dispatch;
    DispatchTable[IRP_MJ_CLOSE] = natdriverprac9Dispatch;
    DispatchTable[IRP_MJ_DEVICE_CONTROL] = natdriverprac9DeviceIoControl;
    ...
    DEBUGP(DL_TRACE, "<==natdriverprac9RegisterDevice: %x\n", Status);
